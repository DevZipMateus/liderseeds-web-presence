    ...
    backgroundImage: `url(${heroBg})`
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="backdrop-blur-sm rounded-3xl p-8 md:p-12 text-center bg-black/0">
            ...
            <h2 className="text-2xl md:text-3xl text-white/95 mb-8 animate-fade-in drop-shadow-md" style={{
            animationDelay: "0.1s"
          }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto mt-12">
            <div className="flex flex-col items-center gap-3 animate-fade-in bg-white/10 backdrop-blur-sm rounded-xl p-6" style={{
            animationDelay: "0.4s"
          }}>
